...
(optionally with a name-substring filter, e.g. `./test.sh notifier`) — 592 checks across 38 files, no test framework, run under VSCodium's bundled node since this
